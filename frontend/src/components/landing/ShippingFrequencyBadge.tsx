...
export function ShippingFrequencyBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-2 rounded-full border border-boss-gold/40 bg-boss-gold/10 px-3 py-1.5 text-xs font-bold uppercase tracking-wide text-boss-gold ${className}`}
    >
