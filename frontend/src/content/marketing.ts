...
export const SHIPPING_FREQUENCY_BADGE = '3× weekly Miami → Jamaica'
export const SHIPPING_FREQUENCY_SHORT = '3 times per week'
export const SHIPPING_FREQUENCY_BLURB =
  'We ship from our Florida warehouse to Jamaica three times per week, so your packages spend less time waiting in Miami and more time on the way to yaad.'
...
export const ABOUT_PARAGRAPHS = [
  ...
  'Through our dependable and convenient services — including three weekly departures from Miami — we make international shipping simple, secure, and hassle-free, giving you peace of mind from purchase to pick up.',
]
...
export const SERVICES: ServiceItem[] = [
  {
    ...
    summary:
      'Live updates from our Florida warehouse until your package is ready in Jamaica.',
    description:
      'We keep you informed every step of the way, with timely updates on your package\'s journey from our Florida warehouse until it is ready in Jamaica. With three weekly shipments from Miami, your packages keep moving.',
    icon: LocateFixed,
  },
  {
  ...
  },
  {
    ...
    summary:
      'Kingston & Portmore delivery, weekday pickup, and islandwide partners.',
    description:
      'Delivery within Kingston and Portmore on designated days for a fee. Collect from our drop-off points on Mondays, Wednesdays, Fridays, and Saturdays. Outside Kingston and Portmore, we use trusted partners including Knutsford Express and Zipmail for islandwide access.',
    icon: Truck,
  },
]

export const PICKUP_DAYS = 'Mondays, Wednesdays, Fridays, and Saturdays'
